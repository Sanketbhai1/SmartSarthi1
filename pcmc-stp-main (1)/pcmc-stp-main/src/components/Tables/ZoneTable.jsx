...
import { deleteZone } from "../../services/operations/zoneAPI";
import { useDispatch } from "react-redux";
import ZonesForm from "../Forms/ZonesForm";
          ...
          <div className="flex gap-2">
            ...
            <button
              onClick={() => {
                ...
                dispatch(deleteZone(row.original.id));
              }}
  ...
  return (
    <div className="p-6 rounded-2xl shadow-lg bg-white max-w-full mx-auto border border-gray-200">
      ...
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-3xl font-bold text-gray-800">Zones</h2>
        <input
          type="text"
          placeholder="Search"
          value={globalFilter}
